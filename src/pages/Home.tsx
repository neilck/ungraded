...
export function Home() {
  const features = [
    {
      ...
      description: "Generate personalized, meaningful feedback at scale while maintaining authentic human connection."
    },
    {
      icon: Target,
      title: "Verify Understanding",
      description: "Go beyond grades with interactive quizzes that assess real comprehension, not just answers."
    },
    {
      icon: Clock,
      title: "Save 50% Time",
      description: "Reduce grading workload by half while providing more detailed, actionable feedback to students."
    },
    {
      icon: Shield,
      title: "Ethical AI Detection",
      description: "Detect AI use responsibly and turn it into a learning opportunity rather than punishment."
    },
    {
      icon: TrendingUp,
      title: "Track Growth",
      description: "Monitor student progress with detailed analytics and insights into learning patterns."
    },
    {
      icon: MessageSquare,
      title: "Interactive Dialogue",
      description: "Enable meaningful conversations around student work with AI-assisted discussion prompts."
    }
  ];
  ...
  const steps = [
    {
      ...
      description: "Submit student work or assignment guidelines to get started."
    },
    {
      number: "02",
      title: "AI Analysis",
      description: "Our system analyzes submissions and generates personalized feedback."
    },
    {
      number: "03",
      title: "Verify Learning",
      description: "Students engage with interactive quizzes to demonstrate understanding."
    },
    {
      number: "04",
  ...
  const testimonials = [
    {
      quote: "Ungraded has transformed how I give feedback. My students are more engaged than ever.",
      author: "Dr. Sarah Chen",
      role: "High School English Teacher",
      school: "Vancouver, BC"
    },
    {
      quote: "The time savings are incredible. I can finally focus on what matters - teaching.",
      author: "Michael Torres",
      role: "College Professor",
      school: "UBC"
    },
    {
      quote: "Students actually want to revise their work now. The feedback is that good.",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                <Badge className="mb-6 bg-[#EAF2FB] text-[#2D70C9] border-[#2D70C9]/20" style={{ fontFamily: 'var(--font-poppins)' }}>
              ...
              >
                Ungraded AI helps teachers verify real understanding and provide personalized feedback — without the grading burden.
              </motion.p>
      ...
      {/* Features Section */}
      <section id="features" className="py-16 sm:py-20 lg:py-32 relative overflow-hidden">
        <FloatingShapes />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 relative z-10">
          <motion.div 
          ...
          >
            ...
            >
              Powerful tools designed to help educators give personalized feedback without the burnout.
            </p>
          </motion.div>
              ...
              >
                <Card className="p-8 h-full hover:shadow-xl transition-shadow border-gray-100">
                  <motion.div 
                    ...
                    transition={{ duration: 0.6 }}
                  >
                    <feature.icon className="w-7 h-7 text-[#2D70C9]" strokeWidth={1.5} />
                  </motion.div>
                  <h3 className="text-[#1A1A1A] mb-3" style={{ fontFamily: 'var(--font-poppins)', fontSize: '1.25rem', fontWeight: '600' }}>
                    {feature.title}
                  </h3>
              ...
              >
                <div className="text-center">
                  <motion.div 
                    ...
                    style={{ fontFamily: 'var(--font-poppins)', fontSize: '1.5rem', fontWeight: '700' }}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-20 text-center relative z-10">
          ...
          >
            Join 500+ educators using Ungraded to give meaningful feedback at scale.
          </motion.p>
          <motion.div 
