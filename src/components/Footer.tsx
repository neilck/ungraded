  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
        ...
        >
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm" style={{ fontFamily: 'var(--font-inter)' }}>
              Building technology that teachers can trust — because we're educators first.
            </p>
          </div>
        ...
        >
          <p className="text-gray-400 text-center text-sm sm:text-base" style={{ fontFamily: 'var(--font-inter)' }}>
